...
const CustomerStreamsLogModel = (props) => {
  ...
  return (
    ...
    >
      <DialogTitle disableTypography className={classes.dialogTitle}>
        <Typography variant='h6'>Customer Streams Audit</Typography>
        <IconButton
          disableRipple
          disableTouchRipple
            ...
            <TableBody>
              {false ? (
                ...
                [0, 1, 2].map((customer) => (
                  ...
                  >
                    <TableCell align='left'>Avenceon</TableCell>
...
export default CustomerStreamsLogModel
